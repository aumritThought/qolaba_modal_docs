...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model wavymulder/portraitplus")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="wavymulder/portraitplus"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "wavymulder/portraitplus", subfolder="scheduler"
            )
    
    a=stableDiffusion()

stub = Stub("portraitplus")
...
@web_endpoint(label="portraitplus", method="POST")
def get_image(
