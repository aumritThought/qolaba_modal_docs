...
model_schema={
    "model_id":"sinkinai/reliberate_v10",
    "memory":10240,
    "container_idle_timeout":600,
    "name":"reliberate_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model sinkinai/reliberate_v10")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="sinkinai/reliberate_v10"
