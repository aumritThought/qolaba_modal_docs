...
model_schema={
    "model_id":"darkstorm2150/Protogen_Eclipse_Official_Release",
    "memory":10240,
    "container_idle_timeout":600,
    "name":"Protogen_Eclipse_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model darkstorm2150/Protogen_Eclipse_Official_Release")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="darkstorm2150/Protogen_Eclipse_Official_Release"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "darkstorm2150/Protogen_Eclipse_Official_Release", subfolder="scheduler"
            )
