...
model_schema={
    "model_id":"stablediffusionapi/all-526-animated",
    "memory":10240,
    "container_idle_timeout":600,
    "name":"all-526-animated_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model stablediffusionapi/all-526-animated")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="stablediffusionapi/all-526-animated"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "stablediffusionapi/all-526-animated", subfolder="scheduler"
            )
