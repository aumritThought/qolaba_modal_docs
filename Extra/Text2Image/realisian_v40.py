...
model_schema={
    "model_id":"redstonehero/realisian_v40",
    "memory":10240,
    "container_idle_timeout":600,
    "name":"realisianv40_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model redstonehero/realisian_v40")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="redstonehero/realisian_v40"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "redstonehero/realisian_v40", subfolder="scheduler"
            )
