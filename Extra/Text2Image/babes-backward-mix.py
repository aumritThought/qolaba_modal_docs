...
model_schema={
    "model_id":"abbiepam/babes-backward-mix",
    "memory":10240,
    "container_idle_timeout":60,
    "name":"babes-backward-mix_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model abbiepam/babes-backward-mix")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="abbiepam/babes-backward-mix"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "abbiepam/babes-backward-mix", subfolder="scheduler"
            )
...
class stableDiffusion:   
    ...
    def run_inference(self,prompt,height,width,num_inference_steps,guidance_scale,negative_prompt,batch):
        ...
        prompt=prompt+", (((((Babes 2.0 , SexyToons, 0.5), KissableLips, 0.5), Ex8, 0.5), Ex7 0.5), Babes 1.1, 0.5)"
        prompt = [prompt] * batch
