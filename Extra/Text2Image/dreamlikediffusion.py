...
model_schema={
    ...
    "name":"dreamlike-diffusion-1.0_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model dreamlike-art/dreamlike-diffusion-1.0")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="dreamlike-art/dreamlike-diffusion-1.0"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "dreamlike-art/dreamlike-diffusion-1.0", subfolder="scheduler"
            )
