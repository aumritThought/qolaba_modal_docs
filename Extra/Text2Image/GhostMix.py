...
model_schema={
    "model_id":"sinkinai/GhostMix-V2-BakedVae",
    "memory":10240,
    "container_idle_timeout":600,
    "name":"ghostmix_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model sinkinai/GhostMix-V2-BakedVae")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="sinkinai/GhostMix-V2-BakedVae"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "sinkinai/GhostMix-V2-BakedVae", subfolder="scheduler"
            )
