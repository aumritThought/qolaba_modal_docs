...
model_schema={
    ...
    "name":"mo-di-diffusion_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model nitrosocke/mo-di-diffusion")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="nitrosocke/mo-di-diffusion"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "nitrosocke/mo-di-diffusion", subfolder="scheduler"
            )
...
class stableDiffusion:   
    ...
    def run_inference(self,prompt,height,width,num_inference_steps,guidance_scale,negative_prompt,batch):
        ...
        prompt = prompt+", modern disney style"
        prompt = [prompt] * batch
