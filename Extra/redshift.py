...
model_schema={
    "model_id":"nitrosocke/redshift-diffusion-768",
    "memory":10240,
    "container_idle_timeout":60,
    "name":"redshift-diffusion_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model "+model_schema["model_id"])
