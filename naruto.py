...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model lambdalabs/sd-naruto-diffusers")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="lambdalabs/sd-naruto-diffusers"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "lambdalabs/sd-naruto-diffusers", subfolder="scheduler"
            )
    
    a=stableDiffusion()

stub = Stub("naruto-diffusers")
...
@web_endpoint(label="naruto-diffusers", method="POST")
def get_image(
