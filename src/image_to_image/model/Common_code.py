...
def get_schema():
    model_schema = {"memory": 10240, "container_idle_timeout": 200, "gpu": "a10g"}
    return model_schema
...
class stableDiffusion_:
    ...
    def run_inference(
        self, img, prompt, guidance_scale, negative_prompt, batch, strength
    ):
        import torch
        ...
        for i in range(0, batch):
            ...
            thread = threading.Thread(
                target=lambda: results.append(self.generate_image_urls(image))
            )
