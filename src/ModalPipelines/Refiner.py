...
from src.utils.Constants import VOLUME_NAME, VOLUME_PATH, SECRET_NAME, OUTPUT_IMAGE_EXTENSION, REFINER_ERROR_MSG, IMAGE_GENERATION_ERROR
import torch, time
...
stub_name = StubNames().flux_refiner
...
class stableDiffusion:
    ...
    def run_inference(self, parameters : dict) -> dict:
        try:
            ...
            raise Exception(IMAGE_GENERATION_ERROR, REFINER_ERROR_MSG)