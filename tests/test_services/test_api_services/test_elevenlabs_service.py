...
def test_init(mocker):
    ...
    mocker.patch.object(ElvenLabsAudio, 'elevenlabs_api_key', 'mock_api_key', create=True)
...
def test_get_audio_length(mocker):
    ...
    mocker.patch('src.FastAPIServer.services.ApiServices.ElvenLabsAudio.AudioSegment.from_file', 
...
def test_generate_audio(mocker):
    ...
    # Mock GCP upload
    mocker.patch('src.FastAPIServer.services.ApiServices.ElvenLabsAudio.upload_data_gcp', 
                 return_value="https://storage.url/audio.mp3")
    
    # Mock prepare_response
    mocker.patch('src.FastAPIServer.services.ApiServices.ElvenLabsAudio.prepare_response',
    ...
    from src.FastAPIServer.services.ApiServices.ElvenLabsAudio import upload_data_gcp, prepare_response
