...
def test_make_api_request(mocker):
    ...
    mock_make_request = mocker.patch("src.FastAPIServer.services.ApiServices.LeonardoService.make_request")
...
def test_remote(mocker):
    ...
    mocker.patch("src.FastAPIServer.services.ApiServices.LeonardoService.timing_decorator", 
                lambda func: func)
