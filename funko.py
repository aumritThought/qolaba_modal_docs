...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model prompthero/funko-diffusion")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="prompthero/funko-diffusion"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "prompthero/funko-diffusion", subfolder="scheduler"
            )
    
    a=stableDiffusion()

stub = Stub("funko-diffusion")
...
@web_endpoint(label="funko-diffusion", method="POST")
def get_image(
