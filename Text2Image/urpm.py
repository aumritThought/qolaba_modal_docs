...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model ductridev/uber-realistic-porn-merge-urpm")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="ductridev/uber-realistic-porn-merge-urpm"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "ductridev/uber-realistic-porn-merge-urpm", subfolder="scheduler"
            )
...
# # from diffusers import SafeStableDiffusionSafetyChecker
# import diffusers

# model_id = "ductridev/uber-realistic-porn-merge-urpm"

# # Use the DPMSolverMultistepScheduler (DPM-Solver++) scheduler here instead
# pipe = StableDiffusionPipeline.from_pretrained(model_id, torch_dtype=torch.float16)
# pipe.scheduler = DPMSolverMultistepScheduler.from_config(pipe.scheduler.config)
# pipe.safety_checker=diffusers.pipelines.stable_diffusion.safety_checker.StableDiffusionSafetyChecker
# pipe.requires_safety_checker= True
# pipe = pipe.to("cuda")
