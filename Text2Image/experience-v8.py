...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model n0madic/experience-v8")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="n0madic/experience-v8"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "n0madic/experience-v8", subfolder="scheduler"
            )
    
    a=stableDiffusion()

stub = Stub("experiencev8")
