...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model proximasanfinetuning/luna-diffusion")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="proximasanfinetuning/luna-diffusion"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "proximasanfinetuning/luna-diffusion", subfolder="scheduler"
            )
    
    a=stableDiffusion()

stub = Stub("luna-diffusion")
