...
model_schema={
    ...
    "name":"CyberRealistic_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --ckpt https://huggingface.co/cyberdelia/CyberRealistic/blob/main/CyberRealistic_V3.1.safetensors")
