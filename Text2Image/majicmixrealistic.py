...
model_schema={
    "model_id":"stablediffusionapi/majicmixrealistic",
    "memory":10240,
    "container_idle_timeout":600,
    "name":"majicmixrealistic_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model stablediffusionapi/majicmixrealistic")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="stablediffusionapi/majicmixrealistic"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "stablediffusionapi/majicmixrealistic", subfolder="scheduler"
            )
