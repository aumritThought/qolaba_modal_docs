...
model_schema={
    ...
    "name":"Realistic_Vision_V2.0_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model SG161222/Realistic_Vision_V2.0")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="SG161222/Realistic_Vision_V2.0"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "SG161222/Realistic_Vision_V2.0", subfolder="scheduler"
            )
