...
model_schema={
    ...
    "name":"edge-of-realism_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model stablediffusionapi/edge-of-realism")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="stablediffusionapi/edge-of-realism"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "stablediffusionapi/edge-of-realism", subfolder="scheduler"
            )
