...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model stablediffusionapi/rev-anim")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="stablediffusionapi/rev-anim"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "stablediffusionapi/rev-anim", subfolder="scheduler"
            )
