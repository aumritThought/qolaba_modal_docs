...
def download_models():
    ...
    import torch
    pipe = StableDiffusionXLPipeline.from_single_file("../ZavyChromaXL.safetensors", torch_dtype=torch.float16, use_safetensors=True, variant="fp16")
    pipe.to("cuda")
...
class stableDiffusion:   
    def __enter__(self):
        ...
        self.pipe = StableDiffusionXLPipeline.from_single_file("../ZavyChromaXL.safetensors", torch_dtype=torch.float16, use_safetensors=True, variant="fp16")
        self.pipe.to("cuda")
