...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model stablediffusionapi/all-526")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="stablediffusionapi/all-526"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "stablediffusionapi/all-526", subfolder="scheduler"
            )
