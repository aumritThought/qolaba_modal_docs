...
model_schema={
    "model_id":"ItsJayQz/SynthwavePunk-v2",
    "memory":10240,
    "container_idle_timeout":600,
    "name":"SynthwavePunk-v2_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model ItsJayQz/SynthwavePunk-v2")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="ItsJayQz/SynthwavePunk-v2"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "ItsJayQz/SynthwavePunk-v2", subfolder="scheduler"
            )
