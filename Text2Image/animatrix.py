...
model_schema={
    ...
    "name":"animatrixv20_text2image",
    "gpu":"a10g"
}
def download_models():
    from diffusers import StableDiffusionXLPipeline
    import torch
    pipe = StableDiffusionXLPipeline.from_single_file("../miaanime.safetensors", torch_dtype=torch.float16, use_safetensors=True, variant="fp16")
    pipe.to("cuda")
...
class stableDiffusion:   
    def __enter__(self):
        ...
        self.pipe = StableDiffusionXLPipeline.from_single_file("../miaanime.safetensors", torch_dtype=torch.float16, use_safetensors=True, variant="fp16")
        self.pipe.to("cuda")
