...
model_schema={
    "model_id":"DucHaiten/DucHaitenSuperCute",
    "memory":10240,
    "container_idle_timeout":60,
    "name":"DucHaitenSuperCute_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model DucHaiten/DucHaitenSuperCute")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="DucHaiten/DucHaitenSuperCute"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "DucHaiten/DucHaitenSuperCute", subfolder="scheduler"
            )
