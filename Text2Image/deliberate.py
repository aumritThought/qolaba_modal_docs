...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model stablediffusionapi/deliberate-v2")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="stablediffusionapi/deliberate-v2"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "stablediffusionapi/deliberate-v2", subfolder="scheduler"
            )
