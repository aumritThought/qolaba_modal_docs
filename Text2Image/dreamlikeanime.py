...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model dreamlike-art/dreamlike-anime-1.0")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="dreamlike-art/dreamlike-anime-1.0"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "dreamlike-art/dreamlike-anime-1.0", subfolder="scheduler"
            )
