...
model_schema={
    ...
    "name":"Inkpunk-Diffusion_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model Envvi/Inkpunk-Diffusion")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="Envvi/Inkpunk-Diffusion"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "Envvi/Inkpunk-Diffusion", subfolder="scheduler"
            )
