...
model_schema={
    "model_id":"abbiepam/all-babes-in-1",
    "memory":10240,
    "container_idle_timeout":60,
    "name":"all-babes-in-1_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model abbiepam/all-babes-in-1")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="abbiepam/all-babes-in-1"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "abbiepam/all-babes-in-1", subfolder="scheduler"
            )
...
class stableDiffusion:   
    ...
    def run_inference(self,prompt,height,width,num_inference_steps,guidance_scale,negative_prompt,batch):
        ...
        prompt=prompt+ ", (((((Babes 1.1 , Ex7, 0.5), Ex8, 0.5), KissableLips, 0.5), SexyToons, 0.5), Babes 2.0, 0.5)"
        prompt = [prompt] * batch
