...
model_schema={
    "model_id":"wavymulder/wavyfusion",
    "memory":10240,
    "container_idle_timeout":60,
    "name":"WavyDiffusion_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model wavymulder/wavyfusion")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="wavymulder/wavyfusion"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "wavymulder/wavyfusion", subfolder="scheduler"
            )
