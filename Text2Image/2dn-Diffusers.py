...
model_schema={
    "model_id":"LottePeisch/2dn-Diffusers",
    "memory":10240,
    "container_idle_timeout":60,
    "name":"2dn-Diffusers_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model LottePeisch/2dn-Diffusers")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="LottePeisch/2dn-Diffusers"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "LottePeisch/2dn-Diffusers", subfolder="scheduler"
            )
