...
model_schema={
    "model_id":"danbrown/RPG-v4",
    "memory":10240,
    "container_idle_timeout":600,
    "name":"RPG-v4_text2image",
    "gpu":"a10g"
}
...
def download_models():
    ...
    import torch
    pipe = StableDiffusionXLPipeline.from_single_file("../nightvision.safetensors", torch_dtype=torch.float16, use_safetensors=True, variant="fp16")
    pipe.to("cuda")
...
class stableDiffusion:   
    def __enter__(self):
        ...
        self.pipe = StableDiffusionXLPipeline.from_single_file("../nightvision.safetensors", torch_dtype=torch.float16, use_safetensors=True, variant="fp16")
        self.pipe.to("cuda")
