...
def download_models():
    ...
    pipe = StableDiffusionXLPipeline.from_single_file("https://huggingface.co/FFusion/FFXL400/blob/main/FFXL400-LoRA-XL-FFusion-v1.1.fp16.safetensors", variant="fp16")
...
class stableDiffusion:   
    def __init__(self):
        ...
        self.pipe = StableDiffusionXLPipeline.from_single_file("https://huggingface.co/FFusion/FFXL400/blob/main/FFXL400-LoRA-XL-FFusion-v1.1.fp16.safetensors", variant="fp16")
