...
def download_models():
    ...
    pipe.load_lora_weights("Qolaba/Lora_Models",  weight_name="vr_headset.safetensors")
...
class stableDiffusion:   
    def __enter__(self):
        ...
        self.pipe.load_lora_weights("Qolaba/Lora_Models",  weight_name="vr_headset.safetensors")
