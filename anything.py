...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model andite/anything-v4.0")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="andite/anything-v4.0"
...
@web_endpoint(label="anythingv4", method="POST")
def get_image(
