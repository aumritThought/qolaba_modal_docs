...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model nitrosocke/redshift-diffusion")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="nitrosocke/redshift-diffusion"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "nitrosocke/redshift-diffusion", subfolder="scheduler"
            )
    
    a=stableDiffusion()

stub = Stub("redshift-diffusion")
...
@web_endpoint(label="redshift-diffusion", method="POST")
def get_image(
