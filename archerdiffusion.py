...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model nitrosocke/archer-diffusion")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="nitrosocke/archer-diffusion"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "nitrosocke/archer-diffusion", subfolder="scheduler"
            )
    
    a=stableDiffusion()

stub = Stub("archer-diffusion")
...
@web_endpoint(label="archer-diffusion", method="POST")
def get_image(
