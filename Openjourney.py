...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model prompthero/openjourney")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="prompthero/openjourney"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "prompthero/openjourney", subfolder="scheduler"
            )
    
    a=stableDiffusion()

stub = Stub("openjourney")
...
@web_endpoint(label="openjourney", method="POST")
def get_image(
