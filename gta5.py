...
def download_models():
    ...
    os.system("python3 scripts/download_pipeline.py --model ItsJayQz/GTA5_Artwork_Diffusion")
    ...
    class stableDiffusion:   
        def __init__(self):
            ...
            hf_hub_or_path="ItsJayQz/GTA5_Artwork_Diffusion"
            ...
            self.pipe.scheduler = EulerDiscreteScheduler.from_pretrained(
                "ItsJayQz/GTA5_Artwork_Diffusion", subfolder="scheduler"
            )
    
    a=stableDiffusion()

stub = Stub("GTA5_Artwork_Diffusion")
...
@web_endpoint(label="gta5", method="POST")
def get_image(
