...
model_schema["name"]="Project_AIO"+"_image2image"
...
def download_models():
    ...
    import torch
    pipe = StableDiffusionXLImg2ImgPipeline.from_single_file("../protovision.safetensors", torch_dtype=torch.float16, use_safetensors=True, variant="fp16")
    pipe.to("cuda")
...
class stableDiffusion():
    def __enter__(self):
        ...
        self.image_pipe = StableDiffusionXLImg2ImgPipeline.from_single_file("../protovision.safetensors", torch_dtype=torch.float16)
