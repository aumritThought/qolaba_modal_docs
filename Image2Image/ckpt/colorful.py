...
model_schema["name"]="colorfulv30"+"_image2image"
...
def download_models():
    ...
    import torch
    pipe = StableDiffusionXLImg2ImgPipeline.from_single_file("../realitiesedge.safetensors", torch_dtype=torch.float16, use_safetensors=True, variant="fp16")
    pipe.to("cuda")
...
class stableDiffusion():
    def __enter__(self) -> None:
        ...
        self.image_pipe = StableDiffusionXLImg2ImgPipeline.from_single_file("../realitiesedge.safetensors", torch_dtype=torch.float16)
